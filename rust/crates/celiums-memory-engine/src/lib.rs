...
pub use derived::{
    ...
    DerivedMemory, DerivedMetrics, DerivedSource, DerivedStatus, ForgetDerivedSourceRequest,
    ForgetMode, ForgetPropagationReport, InvalidDerived, PeriodWindow, RollbackReport,
    ScheduleTrigger,
};
...
pub use graph::{
    ...
    EntityTypeDefinition, GraphDecodeError, GraphEvidenceInput, GraphIntegrityIssue,
    GraphIntegrityReport, GraphMemoryBinding, GraphTraversalRequest, GraphTraversalResult,
