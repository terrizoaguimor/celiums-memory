...
// Open-source fallback. Only used when CELIUMS_LLM_MODEL is unset — every
// deployed env sets it explicitly. Must never default to a closed model
// (was 'gpt-4o-mini'; changed 2026-05-15, #156 — OSS-only policy).
